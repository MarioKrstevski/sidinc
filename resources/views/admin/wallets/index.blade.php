        ...
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Wallet">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.wallet.fields.credit_card') }}
                    </th>
                    <th>
                        {{ trans('cruds.wallet.fields.current_amount') }}
                    </th>
                    <th>
                        {{ trans('cruds.wallet.fields.checkout_amount') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
{ data: 'checkout_amount', name: 'checkout_amount' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
    ],
    order: [[ 1, 'desc' ]],
    pageLength: 100,
  };
  $('.datatable-Wallet').DataTable(dtOverrideGlobals);
