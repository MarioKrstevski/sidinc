    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.wallets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit_card') ? 'is-invalid' : '' }}" type="text" name="credit_card" id="credit_card" value="{{ old('credit_card', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_amount') ? 'is-invalid' : '' }}" type="number" name="current_amount" id="current_amount" value="{{ old('current_amount', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('checkout_amount') ? 'is-invalid' : '' }}" type="number" name="checkout_amount" id="checkout_amount" value="{{ old('checkout_amount', '70') }}" step="0.01" required>
